/*******************************************************************************
* File name: C:\Users\palacios\OneDrive for Business\S\DEV\Utility\label_ACS_2015_v2.do
* Author(s): Cecile Murray, Vincent Palacios
* Start Date: 10/20/16
* Posted Date: 10/20/16
* Description: Labels 2015 ACS PUMS 1-yr data
...
capture label variable OCCP "Occupation recode for 2012 and later based on 2010 OCC codes"
capture label define occpLB ///
...
9920 "UNEMPLOYED AND LAST WORKED 5 YEARS AGO OR EARLIER OR NEVER WORKED **"
capture label values OCCP occpLB
